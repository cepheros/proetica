<?php
class Cadastros_PessoasController extends Zend_Controller_Action{
	...
	public function cadastroAction(){
		...
		if(!$dadosoutros['chavesoap']){
		$dadosoutros['chavesoap'] = sha1($dados['cnpj']);
		}
	...
	public function getcontatosAction(){
		...
		$sub =  $db->fetchAll("id_pessoa = '$id'")->toArray();
