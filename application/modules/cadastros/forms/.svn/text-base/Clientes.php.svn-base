...
class Cadastros_Form_Clientes extends System_Form_Formdecorator{
	...
	public function contatos(){
		...
		//definindo a posição do elemento no formulário
		$this->configurandoTamanho('nomecontato','span12');
		//definindo o grupo que o elemento pertencerá
		...
		//definindo a posição do elemento no formulário
		$this->configurandoTamanho('contato','span12');
		...
		//definindo a posição do elemento no formulário
		$this->configurandoTamanho('ramal','span12');
		...
		//definindo a posição do elemento no formulário
		$this->configurandoTamanho('telresidencial','span12');
		//definindo o grupo que os elementos pertencerão
		...
		//definindo a posição do elemento no formulário
		$this->configurandoTamanho('celular','span12');
		...
		//definindo a posição do elemento no formulário
		$this->configurandoTamanho('email','span12');
		
		$this->montandoGrupo(array('nomecontato','telcomercial','ramal','telresidencial','celular','email'), 'grupo1',array('legend'=>'PORRA'));
		
		$submit = new Zend_Form_Element_Submit('submitcontato');
		$submit->setLabel('Salvar')
		->setAttrib('class', 'btn btn-large btn-primary')
		->setIgnore(true);
		$this->addElement($submit);
		
		$limpar = new Zend_Form_Element_Reset('liparcontato');
		$limpar->setLabel('Limpar')
		->setAttrib('class', 'btn btn-large btn-warning')
		->setIgnore(true);
		$this->addElement($limpar);
		...
		//os botões por padrão ficarão sempre centralizados desde que façam parte do grupo botoes
		$this->montandoGrupo(array('liparcontato','submitcontato'), 'botoes');
	...
	public function outros(){
		...
		->addValidator("NotEmpty")
		->setAttrib('class', 'required')
		->setMultiOptions(System_Model_Centrodecustos::renderCombo());
		...
		->addValidator("NotEmpty")
		->setAttrib('class', 'required')
		->setMultiOptions(System_Model_Planodecontas::renderCombo());
		...
		->addValidator("NotEmpty")
		->setAttrib('class', 'required')
		->setMultiOptions(array(''=>'- Selecione -','1'=>'Emitente','0'=>'Destinatário'));
