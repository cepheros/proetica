...
class Sistema_Form_Empresas extends System_Form_Formdecorator{
	...
	$schemes->setMultiOptions(array(''=>'- Selecione- ','CCe'=>utf8_encode('CCe'),'PL_006i'=>utf8_encode('PL_006i'),
			'PL_006j'=>utf8_encode('PL_006j'),'PL_CTE_104'=>utf8_encode('PL_CTE_104') ,'PL_CTE_101a'=>utf8_encode('PL_CTE_101a')));
	...
	$this->montandoGrupo(array('emailname','processreceivednfe','emailreceiveport'), 'grupo7',array('legend'=>'PORRA'));
